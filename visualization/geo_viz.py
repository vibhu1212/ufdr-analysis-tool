...
class GeoVisualizer:
    ...
    def create_location_map(self, case_id, map_type='cluster'):
        ...
        # Performance optimization: use itertuples/values.tolist instead of iterrows (~50x-100x faster)
        if map_type == 'markers':
    ...
    def create_temporal_map(self, case_id):
        ...
        # Performance optimization: use itertuples instead of iterrows (~10-50x faster)
