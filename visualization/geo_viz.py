...
class GeoVisualizer:
    ...
    def create_location_map(self, case_id, map_type='cluster'):
        ...
        if map_type == 'markers':
            ...
            # Optimization: replaced df.iterrows() with df.itertuples() for 10-50x faster iteration
            ...
            # Create heat map
            # Optimization: vectorized heat_data generation using .values.tolist() entirely avoids slow python-level looping
