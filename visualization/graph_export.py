...
class GraphExporter:
    ...
    def export_anomaly_report(self, case_id, format='csv'):
        ...
        # Daily statistics
        # ⚡ Bolt Optimization: Replaced lambda x: len(set(x)) with native 'nunique'
        # The native pandas string identifier 'nunique' is highly optimized in Cython and
        # performs significantly faster than applying a Python lambda function per group,
        # resolving a known performance bottleneck in large case aggregations.
